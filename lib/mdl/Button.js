        ...
        if ( theBuilder.icon ){
          ...
          return theBuilder.text ? (
            <View style={{flexDirection:'row'}}>
              <Icon name={theBuilder.icon.name} size={theBuilder.icon.size} color={theBuilder.icon.color} />
...
// Colored flat button
function coloredFlatRippleButton() {
  return flatButton()
    .withRippleColor(getTheme().bgPlain)
    .withRippleLocation('tapLocation')
    .withTextStyle({
      color: getTheme().primaryColor,
      fontWeight: 'bold',
    });
...
Button.coloredFlatRippleButton = coloredFlatRippleButton;
